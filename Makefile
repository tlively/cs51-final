...
physics.o: physics.c dynamic_array.o vector_math.o
	gcc -Werror -g -o physics.o -c physics.c dynamic_array.o vector_math.o -lm -std=c99

graphics.o: graphics.c
	gcc -Werror -o graphics.o -c graphics.c `sdl2-config --cflags --libs` -lm -std=c99

dynamic_array.o: dynamic_array.c
	gcc -Werror -g -o dynamic_array.o -c dynamic_array.c `sdl2-config --cflags --libs` -lm -std=c99

vector_math.o: vector_math.c
	gcc -Werror -g -o vector_math.o -c vector_math.c `sdl2-config --cflags --libs` -lm -std=c99
